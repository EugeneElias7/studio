...
export const products: Product[] = [
  ...
  { id: '9', name: 'Grapes', description: 'Sweet and juicy green grapes.', price: 5.50, imageUrl: 'https://images.unsplash.com/photo-1632576883732-f131be0be48a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwxNHx8Z3JhcGVzfGVufDB8fHx8MTc1ODM1OTM1NXww&ixlib=rb-4.1.0&q=80&w=1080', imageHint: 'grapes fruit', category: 'fruits', stock: 60 },
  { id: '10', name: 'Avocado', description: 'Creamy and ripe avocados.', price: 3.50, imageUrl: 'https://images.unsplash.com/photo-1671624749229-7d37826013b5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHw1fHxhdm9jYWRvfGVufDB8fHx8MTc1ODM1OTM3M3ww&ixlib=rb-4.1.0&q=80&w=1080', imageHint: 'avocado fruit', category: 'fruits', subcategory: 'Tropical', stock: 50 },
  { id: '11', name: 'Potato', description: 'Versatile and starchy potatoes.', price: 1.20, imageUrl: 'https://images.unsplash.com/photo-1590165482129-1b8b27698780?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHw0fHxwb3RhdG8lMjBmYXJtfGVufDB8fHx8MTc1ODM1OTM5Nnww&ixlib=rb-4.1.0&q=80&w=1080', imageHint: 'potato vegetable', category: 'vegetables', subcategory: 'Root Vegetables', stock: 250 },
